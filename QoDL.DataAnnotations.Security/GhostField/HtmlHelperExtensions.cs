...
namespace QoDL.DataAnnotations.Security.GhostField
{
    ...
    public static class HtmlHelperExtensions
    {
        ...
        public static MvcHtmlString AddAntiSpamGhostField(this HtmlHelper html, string name = "remarks")
        {
            ...
            var content = $"<div class=\"{name}--wrapper\" style=\"{style}\"><label>Remarks</label><input class=\"remark--input\" name=\"{name}\" placeholder=\"yourname@yourdomain.com\" tabindex=\"-1\"></div>";
